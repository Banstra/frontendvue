...
const x = ref(0.5), y = ref(0.5), z = ref(0.5)
...
<template>
  <div class="task">
    ...
    <p>RGB: <strong>{{ result.rgb }}</strong></p>
    <p>HEX: <strong>{{ result.hex }}</strong></p>
  </div>
</template>

<style scoped>
.inputs { display: flex; gap: 0.5rem; margin: 0.5rem 0; }
.preview { width: 100px; height: 50px; border: 1px solid #ccc; border-radius: 4px; }
</style>
